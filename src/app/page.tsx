...
const heroPreview: ProposalDraft = {
    ...
    <div className="min-h-screen bg-[#F3F1E9] text-[#1A1A1A] font-sans selection:bg-emerald-200">
      <nav className="max-w-7xl mx-auto px-6 sm:px-8 h-24 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          <a
            href="#how-it-works"
            className="hidden md:inline-flex bg-white/50 backdrop-blur-sm border border-black/5 px-5 py-2 rounded-full font-semibold text-sm hover:bg-white transition-all shadow-sm"
          >
            How it works
          </a>
          <a
      ...
      <main className="max-w-7xl mx-auto px-6 sm:px-8 pt-10 pb-24">
        ...
        <section id="features" className="scroll-mt-16 pt-28 sm:pt-32">
        ...
        <section id="open-app" className="scroll-mt-10 pt-28 sm:pt-36">
          <div className="mb-10 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div>
              <SectionEyebrow>App workspace</SectionEyebrow>
              <h2 className="mt-4 max-w-3xl text-4xl sm:text-5xl font-bold tracking-[-0.035em]">
                Generate a proposal that already knows the client, platform, and tone.
              </h2>
            </div>
            <p className="max-w-md text-lg leading-relaxed text-[#6B6B6B]">
              This is a mock local workspace for now. It uses React state only, with no backend or accounts.
            </p>
          </div>
            ...
            <div className="grid gap-5 lg:grid-cols-[0.95fr_1.05fr]">
              <div className="rounded-[32px] border border-black/[0.04] bg-[#FBFAF6] p-5 sm:p-6">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="text-xl font-bold tracking-[-0.02em]">Proposal inputs</h3>
                </div>
              ...
              <div className="rounded-[32px] border border-black/[0.04] bg-white p-5 sm:p-6">
                <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <h3 className="text-xl font-bold tracking-[-0.02em]">Generated proposal</h3>
                  </div>
